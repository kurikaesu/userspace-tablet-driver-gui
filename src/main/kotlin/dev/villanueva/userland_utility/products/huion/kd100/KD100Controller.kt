...
class KD100Controller : ProductController() {
    init {
        ...
        mapItems.add(MappableItem(MappableItemType.Button, "K13", DriverCodeIDs.BTN_C.code, 0))
        mapItems.add(MappableItem(MappableItemType.Button, "K14", DriverCodeIDs.BTN_NORTH.code, 0))
        mapItems.add(MappableItem(MappableItemType.Button, "K15", DriverCodeIDs.BTN_WEST.code, 0))
        mapItems.add(MappableItem(MappableItemType.Button, "K16", DriverCodeIDs.BTN_Z.code, 0))
        mapItems.add(MappableItem(MappableItemType.Button, "K17", DriverCodeIDs.BTN_TL.code, 0))
        mapItems.add(MappableItem(MappableItemType.Button, "K18", DriverCodeIDs.BTN_TR.code, 0))
        mapItems.add(MappableItem(MappableItemType.Button, "K19", DriverCodeIDs.BTN_TL2.code, 0))
        mapItems.add(MappableItem(MappableItemType.Button, "K20", DriverCodeIDs.BTN_TR2.code, 0))
    }
