...
class M10K2018Controller : ProductController() {
    init {
        ...
        mapItems.add(MappableItem(MappableItemType.Dial, "TouchDial -> Left", DriverCodeIDs.REL_WHEEL.code, -1))
        mapItems.add(MappableItem(MappableItemType.Button, "DialButton", DriverCodeIDs.BTN_SOUTH.code, 0))
        mapItems.add(MappableItem(MappableItemType.Dial, "TouchDial -> Right", DriverCodeIDs.REL_WHEEL.code, 1))
